...
var _htmlTags = __webpack_require__(39);
...
var EditableElement = function (_React$Component) {
  ...
  function EditableElement(props) {
    ...
    _this.state = {
      ...
      editable: _this.props.allowEditing === true ? _this.props.value === '' || _this.props.editable : false
    };

    _this.renderStaticElement = _this.renderStaticElement.bind(_this);
    _this.renderEditableElement = _this.renderEditableElement.bind(_this);
  ...
  _createClass(EditableElement, [{
    ...
    key: 'renderEditableElement',
    value: function renderEditableElement() {
      var _this2 = this;
...
EditableElement.propTypes = {
  ...
  element: function element(props, propName, componentName) {
    if (_htmlTags2.default.includes(props[propName])) {
      return null;
    }

    return new Error('Invalid prop `' + propName + '` supplied to' + (' `' + componentName + '`. Allowed elements: ' + _htmlTags2.default.join(', ')));
  },
...
var htmlTags = ['article', 'aside', 'blockquote', 'button', 'cite', 'code', 'dd', 'div', 'dt', 'figcaption', 'footer', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'header', 'li', 'main', 'p', 'pre', 'section', 'span', 'td'];

exports.default = htmlTags;
